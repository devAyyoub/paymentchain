 ...
 * @author ayyoub
 */
@Schema(name = "CustomerResponse", description = "Model represent a customer on database")
@Data
public class TransactionResponse {
   @Schema(name = "transactionId", required = true, example = "12345", description = "Unique identifier of the transaction")
